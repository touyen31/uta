...
@section('content')
    ...
    <form action="insert_employee" method="post">
        ...
        <div class="form-group">
            ...
            <input type="phone_number" name="phone_number" class="form-control" id="pwd" placeholder="Enter phone number" >
            <div style="color: red">
        ...
        <div class="form-group">
            ...
            <input type="address" name="address" class="form-control" id="pwd" placeholder="Enter address" >
            <div style="color: red">
        ...
        <div class="form-group">
            ...
            <input type="start_day" name="start_day" class="form-control" id="pwd" placeholder="Enter start day" >
            <div style="color: red">
